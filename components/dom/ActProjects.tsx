...
export const PROJECTS_DATA: ProjectItem[] = [
  ...
  },
  {
    id: 'rag-agent',
    title: 'RAG AI Agent',
    tagline: 'Autonomous Document Agent with Web Search',
  ...
  // ─── Row 2 ───────────────────────────────────────────────────────────
  {
    ...
    solution: 'Interactive financial dashboard with real-time stock quotes, technical indicator charts, and portfolio tracking.',
    features: ['Real-Time Stock Quotes', 'Candlestick Charts', 'Technical Indicators (RSI/MACD)', 'Watchlist Tracker'],
    techStack: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Radix UI', 'Financial APIs'],
  ...
  },
  {
    ...
    solution: 'Smart India Hackathon project connecting ultrasonic sensor-fitted smart bins to an optimized collection dispatch map.',
    features: ['Real-Time Fill Sensors', 'Route Optimization Algorithm', 'Municipal Admin Dashboard', 'Grievance Portal'],
